import { e as createLucideIcon, j as jsxRuntimeExports, q as cn, s as createContextScope, v as o, w as useComposedRefs, x as createSlot, r as reactExports, y as reactDomExports, P as Primitive, z as useLayoutEffect2, A as useCallbackRef, E as useControllableState, F as useId, H as composeEventHandlers, I as Portal$1, J as hideOthers, K as useFocusGuards, M as ReactRemoveScroll, N as FocusScope, O as DismissableLayer, Q as Presence, U as vt, u as useAuth, t as teamModeLabel, B as Button, V as Label, X as Input } from "./index-Dpxe0gIA.js";
  ...
  return [
    {
      userId: "u1",
      username: "BlazeKing",
      joinedAt: Date.now() - 36e5,
      teamMode: "Solo"
    },
    {
      userId: "u2",
      username: "PhantomX99",
      joinedAt: Date.now() - 24e5,
      teamMode: "Solo"
    },
    {
      userId: "u3",
      username: "NightRaider",
      joinedAt: Date.now() - 12e5,
      teamMode: "Solo"
    }
  ];
}
function RoomCodeForm({
  ...
  function handleSubmit() {
    if (!code.trim()) {
      ue.error("Room code is required");
      return;
    }
    ue.success(`Room code posted for ${tournamentId}`);
    onDone();
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 pt-3 border-t border-border", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground uppercase tracking-wider", children: "Room Code" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground uppercase tracking-wider", children: "Password" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
...
function SubmitResultsForm({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 pt-3 border-t border-border", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto rounded border border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs min-w-[380px]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-muted/60 border-b border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left p-2 font-bold text-muted-foreground uppercase tracking-wider", children: "Player" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-center p-2 font-bold text-muted-foreground uppercase tracking-wider", children: "Kills" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-center p-2 font-bold text-muted-foreground uppercase tracking-wider", children: "Position" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-center p-2 font-bold text-muted-foreground uppercase tracking-wider", children: "Damage" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: participants.map((p, idx) => {
        var _a, _b, _c;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-2 font-semibold text-foreground", children: p.username }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  type: "number",
                  min: 0,
                  value: ((_a = results[p.userId]) == null ? void 0 : _a.kills) ?? 0,
                  onChange: (e) => setField(p.userId, "kills", Number(e.target.value)),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  type: "number",
                  min: 1,
                  value: ((_b = results[p.userId]) == null ? void 0 : _b.position) ?? 1,
                  onChange: (e) => setField(p.userId, "position", Number(e.target.value)),
                  className: "h-7 w-16 mx-auto text-center bg-muted border-border text-xs"
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  type: "number",
                  min: 0,
                  value: ((_c = results[p.userId]) == null ? void 0 : _c.damage) ?? 0,
                  onChange: (e) => setField(p.userId, "damage", Number(e.target.value)),
                  className: "h-7 w-16 mx-auto text-center bg-muted border-border text-xs"
                }
              ) })
            ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          ...
          size: "sm",
          onClick: () => {
            ue.success("Match results submitted!");
            onDone();
          },
          "data-ocid": "admin.results.submit_button",
          className: "btn-glow text-xs",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Gavel, { size: 12, className: "mr-1" }),
            " Submit Results"
          ]
        }
      ),
...
function TournamentAdminRow({
  ...
  const [status, setStatus] = reactExports.useState(t.status);
  ...
  function handleStatusChange(val) {
    setStatus(val);
    ue.success(`Status updated to ${val}`);
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Card,
    {
      "data-ocid": `admin.tournament.item.${index2}`,
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-start justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-sm text-foreground uppercase truncate", children: t.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-1.5 items-center", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-xs border-border", children: t.game }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-xs border-border", children: teamModeLabel(t.teamMode) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(CoinBadge, { amount: t.prizePool, variant: "prize", size: "sm" })
            ] })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: status, onValueChange: handleStatusChange, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            SelectTrigger,
            {
              "data-ocid": `admin.tournament.status_select.${index2}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { className: "bg-popover border-border", children: [
            ...
            "Completed",
            "Cancelled"
          ].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: s, className: "text-xs", children: s }, s)) })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              "data-ocid": `admin.tournament.room_button.${index2}`,
              className: "text-xs h-7",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(KeyRound, { size: 11, className: "mr-1" }),
                " Room Code"
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              "data-ocid": `admin.tournament.results_button.${index2}`,
              className: "text-xs h-7",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Gavel, { size: 11, className: "mr-1" }),
                " Submit Results"
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              "data-ocid": `admin.tournament.participants_button.${index2}`,
              className: "text-xs h-7",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { size: 11, className: "mr-1" }),
                " Participants",
                action === "participants" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { size: 11, className: "ml-1" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { size: 11, className: "ml-1" })
              ]
            }
          )
        ] }),
        action === "room" && /* @__PURE__ */ jsxRuntimeExports.jsx(RoomCodeForm, { tournamentId: t.id, onDone: () => setAction(null) }),
        action === "results" && /* @__PURE__ */ jsxRuntimeExports.jsx(
          SubmitResultsForm,
          {
            tournamentId: t.id,
            participants,
        ...
        action === "participants" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-3 border-t border-border space-y-2", children: participants.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "No participants yet." }) : participants.map((p, pi) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            "data-ocid": `admin.participants.item.${pi + 1}`,
            className: "flex items-center justify-between bg-muted/40 px-3 py-2 rounded-sm",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-foreground", children: p.username }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: teamModeLabel(p.teamMode) })
            ]
          },
          p.userId
        )) })
...
function CreateContestTab() {
  ...
  function set(k, v2) {
    setForm((prev) => ({ ...prev, [k]: v2 }));
  }
  function handleCreate() {
    if (!form.title.trim() || !form.startTime) {
      ue.error("Title and start time are required");
      return;
    }
    ue.success(`Contest "${form.title}" created!`);
    setForm({
      title: "",
      game: "FreeFire",
      teamMode: "Solo",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-card border-border", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "font-display text-sm uppercase tracking-wider flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 15, className: "text-primary" }),
      " New Contest"
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-4 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground uppercase tracking-wider", children: "Title *" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground uppercase tracking-wider", children: "Game" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Select,
            {
              value: form.game,
              onValueChange: (v2) => set("game", v2),
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  SelectTrigger,
                  {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground uppercase tracking-wider", children: "Team Mode" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Select,
            {
              value: form.teamMode,
              onValueChange: (v2) => set("teamMode", v2),
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  SelectTrigger,
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { className: "bg-popover border-border", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Solo", children: "Solo" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Duo", children: "Duo" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "Squad", children: "Squad" })
                ] })
              ]
            }
          )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground uppercase tracking-wider", children: "Contest Type" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Select,
            {
              value: form.contestType,
              onValueChange: (v2) => set("contestType", v2),
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  SelectTrigger,
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { className: "bg-popover border-border", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "TopPosition", children: "Top Position" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "MostKills", children: "Most Kills" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "MostDamage", children: "Most Damage" })
                ] })
              ]
            }
          )
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground uppercase tracking-wider", children: "View Mode" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Select,
            {
              value: form.viewMode,
              onValueChange: (v2) => set("viewMode", v2),
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  SelectTrigger,
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { className: "bg-popover border-border", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "TPP", children: "TPP" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "FPP", children: "FPP" })
                ] })
              ]
            }
          )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground uppercase tracking-wider", children: "Entry Fee" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground uppercase tracking-wider", children: "Prize Pool" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground uppercase tracking-wider", children: "Max Players" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground uppercase tracking-wider", children: "Start Time *" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
...
function ManageUsersTab() {
  ...
  function setAdjField(principal, key, value) {
    setAdjustments((prev) => ({
      ...prev,
      [principal]: { ...prev[principal], [key]: value }
    }));
  }
  function handleAdjust(principal) {
    var _a;
    ...
    setUsers(
      (prev) => prev.map(
        (u) => u.principal === principal ? {
          ...u,
          coins: adj.type === "credit" ? u.coins + amt : Math.max(0, u.coins - amt)
        } : u
      )
    );
    setAdjField(principal, "amount", "");
    ue.success(
      `${adj.type === "credit" ? "Credited" : "Debited"} ${amt} coins to ${(_a = users.find((u) => u.principal === principal)) == null ? void 0 : _a.username}`
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: users.map((u, idx) => {
    var _a, _b;
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      Card,
      {
        ...
        className: "bg-card border-border",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3 items-start justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-foreground", children: u.username }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-mono", children: truncatePrincipal(u.principal) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2 pt-0.5 items-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CoinBadge, { amount: u.coins, size: "sm" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Select,
              {
                value: ((_a = adjustments[u.principal]) == null ? void 0 : _a.type) ?? "credit",
                onValueChange: (v2) => setAdjField(u.principal, "type", v2),
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    SelectTrigger,
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { className: "bg-popover border-border", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "credit", className: "text-xs", children: "Credit" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "debit", className: "text-xs", children: "Debit" })
                  ] })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                ...
                min: 1,
                placeholder: "coins",
                value: ((_b = adjustments[u.principal]) == null ? void 0 : _b.amount) ?? "",
                onChange: (e) => setAdjField(u.principal, "amount", e.target.value),
...
function AdminPage() {
  ...
  const [adminExists, setAdminExists] = reactExports.useState(false);
  ...
  function handleClaimAdmin() {
    ...
    setTimeout(() => {
      ...
      setAdminExists(true);
      setClaiming(false);
      ue.success("Admin claimed! You now have full control of FIRE ARENA.");
    }, 900);
  }
  if (!isAuthenticated) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-destructive/20 border border-destructive/40 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { size: 28, className: "text-destructive" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-black text-xl uppercase tracking-tight text-foreground", children: "Access Denied" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1.5", children: "You must be logged in to access the admin panel." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
  ...
  if (!isAdmin) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        className: "flex flex-col items-center justify-center min-h-[60vh] gap-6 text-center px-4",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full bg-destructive/20 border border-destructive/40 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldAlert, { size: 28, className: "text-destructive" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-black text-xl uppercase tracking-tight text-foreground", children: "Admin Access Required" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1.5 max-w-sm", children: "Only the platform admin can access this panel." })
          ] }),
          !adminExists && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 p-5 border border-accent/40 rounded-sm bg-accent/5 max-w-sm w-full space-y-3 text-left", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Crown, { size: 15, className: "text-accent" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-sm text-accent uppercase tracking-wider", children: "No Admin Claimed Yet" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: "You can claim admin rights as the app deployer. This action is one-time and permanent — you'll have full control of the platform." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                ...
                children: claiming ? "Claiming…" : "Claim Admin"
              }
            )
          ] })
        ]
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      PageHeader,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs font-display font-bold uppercase text-primary bg-primary/10 border border-primary/30 px-2 py-1 rounded-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { size: 12 }),
          " Admin"
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "tournaments", "data-ocid": "admin.tabs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "bg-muted border border-border w-full grid grid-cols-3 sm:w-auto sm:flex h-auto p-0.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          TabsTrigger,
          {
            value: "tournaments",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "tournaments", className: "mt-4 space-y-3", children: tournaments.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          "data-ocid": "admin.tournaments.empty_state",
          className: "text-center py-12 text-muted-foreground text-sm",
          children: 'No tournaments found. Create one in "Create Contest".'
        }
      ) : tournaments.map((t, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(TournamentAdminRow, { t, index: idx + 1 }, t.id)) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "create", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CreateContestTab, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "users", className: "mt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ManageUsersTab, {}) })
    ] })
  ] });
}
export {
